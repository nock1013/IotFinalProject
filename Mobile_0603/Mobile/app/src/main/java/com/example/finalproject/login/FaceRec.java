    ...
    class HttpFaceSelect extends AsyncTask<MemberDTO, Void, String>{
        ...
        protected void onPostExecute(String s) {
            ...
            if(password2.equals("1")){
                ...
                Intent intent = new Intent(FaceRec.this, MainActivity.class);
                intent.putExtra("userID",id);
                Log.d("FaceRect: ","얼굴 로그인 아이디"+id);
                startActivity(intent);
                finish();
            }else if(s.equals("0")){
                Toast.makeText(FaceRec.this,"얼굴 로그인 실패",Toast.LENGTH_SHORT).show();
            }
        }
...
/*    //얼굴 로그인
    class HttpLoginFace extends AsyncTask<MemberDTO, Void, String>{
        String result;
        @Override
        protected String doInBackground(MemberDTO... memberDTOS) {
            URL url = null;
            ...
            try {
                ...
                url = new URL("http://70.12.116.60:8088/gunzip_final/member/login.do");
        ...
        protected void onPostExecute(String s) {
            super.onPostExecute(s);
            if(s.equals("true")){
                Intent intent = new Intent(FaceRec.this, HomeActivity.class);
                intent.putExtra("userID",userID);
                startActivity(intent);
                finish();
                Log.d("FaceRect: ","얼굴 로그인");
            }else{
                Toast.makeText(FaceRec.this,"얼굴 로그인 실패",Toast.LENGTH_SHORT).show();
            }
        }
