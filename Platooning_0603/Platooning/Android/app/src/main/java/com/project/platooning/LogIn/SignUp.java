...
public class SignUp extends AppCompatActivity {
    ...
    class HttpInsert extends AsyncTask<MemberDTO, Void, String>{
        ...
        protected String doInBackground(MemberDTO... memberDTOS) {
            ...
            try {
                ...
                url = new URL("http://70.12.116.60:8088/gunzip_final/member/insert.do");

                OkHttpClient client = new OkHttpClient();
                String json = object.toString();
                Log.d("msg signup json",json);
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.equals("1")){
                ...
                Toast.makeText(SignUp.this,"다시작성해 주세요",Toast.LENGTH_SHORT).show();
                hideDialog();
            }
        }
    }
    ...
    class HttpIDChk extends AsyncTask<MemberDTO, Void, String>{
        ...
        protected String doInBackground(MemberDTO... memberDTOS) {
            ...
            String str="";
            try {
                url = new URL("http://70.12.116.60:8088/gunzip_final/member/chk.do");
